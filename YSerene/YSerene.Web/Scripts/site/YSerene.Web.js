...
(function (YSerene) {
    ...
    })(Administration = YSerene.Administration || (YSerene.Administration = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    var Administration;
...
(function (YSerene) {
    ...
    (function (Common) {
        var MemberSex;
        (function (MemberSex) {
            MemberSex[MemberSex["Boy"] = 0] = "Boy";
            MemberSex[MemberSex["Girl"] = 1] = "Girl";
        })(MemberSex = Common.MemberSex || (Common.MemberSex = {}));
        Serenity.Decorators.registerEnum(MemberSex, 'Default.Sex');
    })(Common = YSerene.Common || (YSerene.Common = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    var Common;
...
(function (YSerene) {
    var Default;
    (function (Default) {
        var EnListForm = (function (_super) {
            __extends(EnListForm, _super);
            function EnListForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            return EnListForm;
        }(Serenity.PrefixedContext));
        EnListForm.formKey = 'Default.EnList';
        Default.EnListForm = EnListForm;
        [['ParentName', function () { return Serenity.StringEditor; }], ['Mobile', function () { return Serenity.StringEditor; }], ['ChildName', function () { return Serenity.StringEditor; }], ['Sex', function () { return Serenity.EnumEditor; }], ['Birthday', function () { return Serenity.DateEditor; }]].forEach(function (x) { return Object.defineProperty(EnListForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
...
(function (YSerene) {
    ...
    (function (Default) {
        var EnListRow;
        (function (EnListRow) {
            EnListRow.idProperty = 'EnId';
            EnListRow.nameProperty = 'ParentName';
            EnListRow.localTextPrefix = 'Default.EnList';
            var Fields;
            (function (Fields) {
            })(Fields = EnListRow.Fields || (EnListRow.Fields = {}));
            [
                'EnId',
                'ParentName',
                'Mobile',
        ...
        })(EnListRow = Default.EnListRow || (Default.EnListRow = {}));
    })(Default = YSerene.Default || (YSerene.Default = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    ...
    (function (Default) {
        var EnListService;
        (function (EnListService) {
            EnListService.baseUrl = 'Default/EnList';
            var Methods;
            (function (Methods) {
            })(Methods = EnListService.Methods || (EnListService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                EnListService[x] = function (r, s, o) {
                    return Q.serviceRequest(EnListService.baseUrl + '/' + x, r, s, o);
                };
                Methods[x] = EnListService.baseUrl + '/' + x;
            });
        })(EnListService = Default.EnListService || (Default.EnListService = {}));
    })(Default = YSerene.Default || (YSerene.Default = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    var Default;
    (function (Default) {
        var NewsCategoryForm = (function (_super) {
            __extends(NewsCategoryForm, _super);
            function NewsCategoryForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            return NewsCategoryForm;
        }(Serenity.PrefixedContext));
        NewsCategoryForm.formKey = 'Default.NewsCategory';
        Default.NewsCategoryForm = NewsCategoryForm;
        [['CategoryName', function () { return Serenity.StringEditor; }], ['Description', function () { return Serenity.TextAreaEditor; }]].forEach(function (x) { return Object.defineProperty(NewsCategoryForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Default = YSerene.Default || (YSerene.Default = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    ...
    (function (Default) {
        var NewsCategoryRow;
        (function (NewsCategoryRow) {
            NewsCategoryRow.idProperty = 'CategoryId';
            NewsCategoryRow.nameProperty = 'CategoryName';
            NewsCategoryRow.localTextPrefix = 'Default.NewsCategory';
            NewsCategoryRow.lookupKey = 'Default.NewsCategory';
            function getLookup() {
                return Q.getLookup('Default.NewsCategory');
            }
            NewsCategoryRow.getLookup = getLookup;
            var Fields;
            (function (Fields) {
            })(Fields = NewsCategoryRow.Fields || (NewsCategoryRow.Fields = {}));
            [
                'CategoryId',
                'CategoryName',
                'Description',
        ...
        })(NewsCategoryRow = Default.NewsCategoryRow || (Default.NewsCategoryRow = {}));
    })(Default = YSerene.Default || (YSerene.Default = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    ...
    (function (Default) {
        ...
        (function (NewsCategoryService) {
            NewsCategoryService.baseUrl = 'Default/NewsCategory';
            var Methods;
            (function (Methods) {
            })(Methods = NewsCategoryService.Methods || (NewsCategoryService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                NewsCategoryService[x] = function (r, s, o) {
                    return Q.serviceRequest(NewsCategoryService.baseUrl + '/' + x, r, s, o);
                };
                Methods[x] = NewsCategoryService.baseUrl + '/' + x;
            });
        })(NewsCategoryService = Default.NewsCategoryService || (Default.NewsCategoryService = {}));
    })(Default = YSerene.Default || (YSerene.Default = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
...
(function (YSerene) {
    ...
    (function (Default) {
        ...
        (function (NewsRow) {
            ...
            NewsRow.localTextPrefix = 'Default.News';
            var Fields;
            (function (Fields) {
        ...
        })(NewsRow = Default.NewsRow || (Default.NewsRow = {}));
    })(Default = YSerene.Default || (YSerene.Default = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    ...
    (function (Default) {
        ...
        (function (NewsService) {
            NewsService.baseUrl = 'Default/News';
            var Methods;
            (function (Methods) {
        ...
        })(NewsService = Default.NewsService || (Default.NewsService = {}));
    })(Default = YSerene.Default || (YSerene.Default = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
...
(function (YSerene) {
    ...
    })(Membership = YSerene.Membership || (YSerene.Membership = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    var Membership;
    (function (Membership) {
        ...
        EnListForm.formKey = 'Membership.CreateEnList';
        Membership.EnListForm = EnListForm;
        [['ParentName', function () { return Serenity.StringEditor; }], ['Mobile', function () { return Serenity.StringEditor; }], ['ChildName', function () { return Serenity.StringEditor; }], ['Sex', function () { return Serenity.RadioButtonEditor; }], ['Birthday', function () { return Serenity.DateEditor; }]].forEach(function (x) { return Object.defineProperty(EnListForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Membership = YSerene.Membership || (YSerene.Membership = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
...
(function (YSerene) {
    ...
    })(Authorization = YSerene.Authorization || (YSerene.Authorization = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    var Administration;
...
(function (YSerene) {
    ...
    YSerene.BasicProgressDialog = BasicProgressDialog;
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    var Common;
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new YSerene.BasicProgressDialog();
...
(function (YSerene) {
    ...
    })(DialogUtils = YSerene.DialogUtils || (YSerene.DialogUtils = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    var Common;
...
(function (YSerene) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = YSerene.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = YSerene.LanguageList || (YSerene.LanguageList = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    /**
    ...
    YSerene.StaticTextBlock = StaticTextBlock;
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    var Common;
...
(function (YSerene) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = YSerene.LanguageList.getValue;
    })(ScriptInitialization = YSerene.ScriptInitialization || (YSerene.ScriptInitialization = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    var Common;
...
(function (YSerene) {
    var Default;
    (function (Default) {
        var EnListDialog = (function (_super) {
            __extends(EnListDialog, _super);
            function EnListDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Default.EnListForm(_this.idPrefix);
                return _this;
            }
            EnListDialog.prototype.getFormKey = function () { return Default.EnListForm.formKey; };
            EnListDialog.prototype.getIdProperty = function () { return Default.EnListRow.idProperty; };
            EnListDialog.prototype.getLocalTextPrefix = function () { return Default.EnListRow.localTextPrefix; };
            EnListDialog.prototype.getNameProperty = function () { return Default.EnListRow.nameProperty; };
            EnListDialog.prototype.getService = function () { return Default.EnListService.baseUrl; };
            //隐藏保存按钮
            EnListDialog.prototype.updateInterface = function () {
        ...
        EnListDialog = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.responsive()
        ], EnListDialog);
        Default.EnListDialog = EnListDialog;
    })(Default = YSerene.Default || (YSerene.Default = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    var Default;
    (function (Default) {
        var EnListGrid = (function (_super) {
            __extends(EnListGrid, _super);
            function EnListGrid(container) {
                return _super.call(this, container) || this;
            }
            EnListGrid.prototype.getColumnsKey = function () { return 'Default.EnList'; };
            EnListGrid.prototype.getDialogType = function () { return Default.EnListDialog; };
            EnListGrid.prototype.getIdProperty = function () { return Default.EnListRow.idProperty; };
            EnListGrid.prototype.getLocalTextPrefix = function () { return Default.EnListRow.localTextPrefix; };
            EnListGrid.prototype.getService = function () { return Default.EnListService.baseUrl; };
            //设置页面操作按钮
            EnListGrid.prototype.getButtons = function () {
                return [];
            };
            return EnListGrid;
        }(Serenity.EntityGrid));
        EnListGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], EnListGrid);
        Default.EnListGrid = EnListGrid;
    })(Default = YSerene.Default || (YSerene.Default = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    var Default;
    (function (Default) {
        var NewsDialog = (function (_super) {
            __extends(NewsDialog, _super);
            function NewsDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Default.NewsForm(_this.idPrefix);
                return _this;
            }
            NewsDialog.prototype.getFormKey = function () { return Default.NewsForm.formKey; };
            NewsDialog.prototype.getIdProperty = function () { return Default.NewsRow.idProperty; };
            NewsDialog.prototype.getLocalTextPrefix = function () { return Default.NewsRow.localTextPrefix; };
            NewsDialog.prototype.getNameProperty = function () { return Default.NewsRow.nameProperty; };
            NewsDialog.prototype.getService = function () { return Default.NewsService.baseUrl; };
            return NewsDialog;
        }(Serenity.EntityDialog));
...
(function (YSerene) {
    var Default;
    (function (Default) {
        var NewsGrid = (function (_super) {
            __extends(NewsGrid, _super);
            function NewsGrid(container) {
                return _super.call(this, container) || this;
            }
            NewsGrid.prototype.getColumnsKey = function () { return 'Default.News'; };
            NewsGrid.prototype.getDialogType = function () { return Default.NewsDialog; };
            NewsGrid.prototype.getIdProperty = function () { return Default.NewsRow.idProperty; };
            NewsGrid.prototype.getLocalTextPrefix = function () { return Default.NewsRow.localTextPrefix; };
            NewsGrid.prototype.getService = function () { return Default.NewsService.baseUrl; };
            return NewsGrid;
        }(Serenity.EntityGrid));
        NewsGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], NewsGrid);
        Default.NewsGrid = NewsGrid;
    })(Default = YSerene.Default || (YSerene.Default = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    var Default;
    (function (Default) {
        var NewsCategoryDialog = (function (_super) {
            __extends(NewsCategoryDialog, _super);
            function NewsCategoryDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Default.NewsCategoryForm(_this.idPrefix);
                return _this;
            }
            NewsCategoryDialog.prototype.getFormKey = function () { return Default.NewsCategoryForm.formKey; };
            NewsCategoryDialog.prototype.getIdProperty = function () { return Default.NewsCategoryRow.idProperty; };
            NewsCategoryDialog.prototype.getLocalTextPrefix = function () { return Default.NewsCategoryRow.localTextPrefix; };
            NewsCategoryDialog.prototype.getNameProperty = function () { return Default.NewsCategoryRow.nameProperty; };
            NewsCategoryDialog.prototype.getService = function () { return Default.NewsCategoryService.baseUrl; };
            return NewsCategoryDialog;
        }(Serenity.EntityDialog));
        NewsCategoryDialog = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.responsive()
        ], NewsCategoryDialog);
        Default.NewsCategoryDialog = NewsCategoryDialog;
    })(Default = YSerene.Default || (YSerene.Default = {}));
})(YSerene || (YSerene = {}));
var YSerene;
(function (YSerene) {
    var Default;
    (function (Default) {
        var NewsCategoryGrid = (function (_super) {
            __extends(NewsCategoryGrid, _super);
            function NewsCategoryGrid(container) {
                return _super.call(this, container) || this;
            }
            NewsCategoryGrid.prototype.getColumnsKey = function () { return 'Default.NewsCategory'; };
            NewsCategoryGrid.prototype.getDialogType = function () { return Default.NewsCategoryDialog; };
            NewsCategoryGrid.prototype.getIdProperty = function () { return Default.NewsCategoryRow.idProperty; };
            NewsCategoryGrid.prototype.getLocalTextPrefix = function () { return Default.NewsCategoryRow.localTextPrefix; };
            NewsCategoryGrid.prototype.getService = function () { return Default.NewsCategoryService.baseUrl; };
            return NewsCategoryGrid;
        }(Serenity.EntityGrid));
        NewsCategoryGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], NewsCategoryGrid);
...
(function (YSerene) {
    var Membership;
    (function (Membership) {
        var CreateEnListPanel = (function (_super) {
            __extends(CreateEnListPanel, _super);
            function CreateEnListPanel(container) {
                var _this = _super.call(this, container) || this;
                _this.form = new Membership.EnListForm(_this.idPrefix);
                ...
                _this.byId('SubmitButton').click(function (e) {
                    ...
                    Q.serviceCall({
                        ...
                        request: {
                            ParentName: _this.form.ParentName.value,
                            Mobile: _this.form.Mobile.value,
                            ChildName: _this.form.ChildName.value,
                            Sex: _this.form.Sex.value,
                            Birthday: _this.form.Birthday.value
                        },
                        onSuccess: function (response) {
                            Q.information("报名成功", function () {
                                window.location.href = Q.resolveUrl('~/');
                            });
                        }
                    });
            ...
            CreateEnListPanel.prototype.getFormKey = function () { return Membership.EnListForm.formKey; };
            return CreateEnListPanel;
        }(Serenity.PropertyPanel));
        CreateEnListPanel = __decorate([
            Serenity.Decorators.registerClass()
        ], CreateEnListPanel);
        Membership.CreateEnListPanel = CreateEnListPanel;
    })(Membership = YSerene.Membership || (YSerene.Membership = {}));
})(YSerene || (YSerene = {}));
//# sourceMappingURL=YSerene.Web.js.map